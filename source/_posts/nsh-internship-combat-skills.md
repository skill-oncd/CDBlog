...
categories:
  - Portfolio
description: 实习期间参与设计的两个战斗技能实机片段，已随版本上线，素材来源于官方宣传视频。
---

## 背景

以下收录了所负责的双刀副武器部分技能的设计与实装，仅收录已随版本上线、可通过公开渠道查看的内容，素材来源于官方宣传视频。
...
> 感谢实习团队的合作与指导。这段经历让我深入理解了大型 MMO 项目的战斗管线，从设计文档到版本上线的完整流程。
